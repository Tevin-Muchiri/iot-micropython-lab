...
def insert_sensor_data(data, topic):
    ...
    device = data.get("device", "Unknown-DHT22")
...
def main():
    ...
    try:
        client = mqtt.Client(
            ...
            client_id="pc-sqlite-subscriber-all-boards"
        )
    except AttributeError:
        client = mqtt.Client(client_id="pc-sqlite-subscriber-all-boards")
    ...
    print("Waiting for sensor data from ESP32 / ESP8266 / Raspberry Pi / Pico W...")
